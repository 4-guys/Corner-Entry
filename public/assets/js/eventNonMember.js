        ...
        function initialRows() {
            ...
            for (var i = 0; i < event.length; i++) {
                var str = "<tr class='table-expand-row' data-open-details><td>"
                    + event[i].eventDate + "</td><td><b>"
                    + event[i].eventName + "</b><span class='expand-icon'></td><td>"
            ...
            if (found) {
             str += "<td>already registered</td>" 
                ...
                str += "<td>" + "<button data-eventId='" + event[i].id + "' class='button' onClick='window.location.reload();'> Sign In to Register </button></tr>"
                }
